...
function LionHub:CreateUI()
    ...
    local function CreateColumn(name, headerText, color)
        ...
        layout.Padding = UDim.new(0, 10) -- Tăng khoảng cách giữa các dòng
...
-- Check for premium item WITH ALTERNATIVE NAMES & kiểm tra thêm các folder đặc biệt
function LionHub:HasPremiumItem(mainItemName)
    ...
    -- Check data inventory & các folder đặc biệt
    local data = LocalPlayer:FindFirstChild("Data")
    if data then
