...
if getgenv().Deleted_Ui then
    library = {}
    function library:CreateWindow(...) local bit_zes = {}
        function bit_zes:CreateTab(...) local cizan = {}
            function cizan:CreateSection(...) local Azin = {}
                function Azin:AddLabel(...) local xp = {} function xp:Set(...) local op = {} return op end return xp end return xp end
    ...
    for mainItemName in pairs(PremiumItems) do
        ...
        itemLabel.TextColor3 = Color3.fromRGB(255,255,255) -- Đổi sang trắng
    ...
    local player = game.Players.LocalPlayer
    local world = Old_World and "Old World" or New_World and "New World" or Three_World and "Third World" or "Unknown"
    local statusLabels = {
        "Name: "..player.Name,
        "World: "..world,
